...
include <key_profiles/taihao.scad>
...
module key_profile(key_profile_type, row, column=0) {
  ...
  } else if (key_profile_type == "taihao") {
    taihao_row(row, column) children();
  } else if (key_profile_type == "dsa") {
    dsa_row(row, column) children();
  } else if (key_profile_type == "dsx") {
    dsx_row(row, column) children();
